...
namespace r2
{
	...
	public:
		static_assert(
			...
			, "r2::Counter_Limit - Not Allowed Type"
		);
		...
		Counter_Limit() : mAlive( false ), mLimit( 0 ), mCount( 0 )
		{}
		explicit Counter_Limit( const ValueT limit ) : mAlive( true ), mLimit( limit ), mCount( 0 )
		{}
