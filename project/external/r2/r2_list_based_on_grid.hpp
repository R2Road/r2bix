...
#include "r2_grid_based_on_vector.hpp"
#include "r2_grid_node_iterator.hpp"

namespace r2
{
	template<typename Coordinate_T, typename Value_T, typename NodeCleaner = GridNodeCleaner_StayValue<Coordinate_T, Value_T>>
	...
	public:
		...
		using IteratorT             = GridNodeIterator<Coordinate_T, ValueT>;
		using ConstIteratorT        = GridNodeConstIterator<Coordinate_T, ValueT>;
		using ReverseIteratorT      = GridNodeReverseIterator<Coordinate_T, ValueT>;
		using ConstReverseIteratorT = GridNodeConstReverseIterator<Coordinate_T, ValueT>;
