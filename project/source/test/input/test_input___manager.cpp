...
namespace test_input___manager
{
	...
	r2tm::TitleFunctionT Order_Cursor___Callback_Block::GetTitleFunction() const
	{
		return []()->const char*
		{
			return "InputManager : Order : Cursor : Callback Block";
		};
	}
	r2tm::DoFunctionT Order_Cursor___Callback_Block::GetDoFunction() const
	{
		return []()->r2tm::eDoLeaveAction
		{
			LS();
...

			{
				OUT_NOTE( "Listener 3개 추가" );
				OUT_NOTE( "각각 order 0, 1, 2" );
				OUT_NOTE( "1번 Listener의 Callback은 true 반환" );
			...
			r2bix_input::Listener4Mouse l_1( 1, r2bix_input::eListenMode::Pass );
			l_1.SetCallback4CursorMoved( [last_cursor = r2bix_input::CursorPoint()]( r2bix_input::CursorPoint c ) mutable
			{
				if( last_cursor != c )
				{
