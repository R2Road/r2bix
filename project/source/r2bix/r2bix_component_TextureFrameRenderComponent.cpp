...
namespace r2bix_component
{
	...
	void TextureFrameRenderComponent::Render_deprecated( const r2bix::Camera_deprecated* const camera, r2bix_render::iRenderTarget* const render_target, r2::PointInt offset )
	{
