...
#include "test/director/menu_director.hpp"
...
r2tm::WriteFunctionT Menu_Dev::GetWriteFunction() const
{
	...
	{
		mp->AddMenu( '1', Menu_R2bix_Input() );
		mp->AddMenu( '2', Menu_Director() );
		...
		mp->AddMenu( 'q', Menu_R2bix() );
		mp->AddMenu( 'w', Menu_Tool() );
