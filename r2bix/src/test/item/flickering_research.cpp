...
{
	r2test::iTest::TitleFunc OneByOne::GetTitleFunction() const
	{
		return []()->const char*
		{
	...
	r2test::iTest::DoFunc OneByOne::GetDoFunction()
	{
	...
	r2test::iTest::TitleFunc OneByOne_WithOut_CLS::GetTitleFunction() const
	{
		return []()->const char*
		{
	...
	r2test::iTest::DoFunc OneByOne_WithOut_CLS::GetDoFunction()
	{
	...
	r2test::iTest::TitleFunc LineByLine::GetTitleFunction() const
	{
		return []()->const char*
		{
	...
	r2test::iTest::DoFunc LineByLine::GetDoFunction()
	{
		return []( r2base::Director& director )->r2test::eTestEndAction
		{
			r2render::Texture visible_resource( 19, 19 );
	...
	r2test::iTest::TitleFunc PageByPage::GetTitleFunction() const
	{
		return []()->const char*
		{
	...
	r2test::iTest::DoFunc PageByPage::GetDoFunction()
	{
		return []( r2base::Director& director )->r2test::eTestEndAction
		{
	...
	r2test::iTest::TitleFunc PageByPage_WithOut_CLS_1::GetTitleFunction() const
	{
		return []()->const char*
		{
	...
	r2test::iTest::DoFunc PageByPage_WithOut_CLS_1::GetDoFunction()
	{
		return []( r2base::Director& )->r2test::eTestEndAction
		{
	...
	r2test::iTest::TitleFunc PageByPage_WithOut_CLS_2::GetTitleFunction() const
	{
		return []()->const char*
		{
	...
	r2test::iTest::DoFunc PageByPage_WithOut_CLS_2::GetDoFunction()
	{
		return []( r2base::Director& )->r2test::eTestEndAction
		{
