...
namespace r2bix_component
{
	...
	public:
		...
		void Set( const r2::Vector2& pivot, const uint32_t width, const uint32_t height, const char rect_char, const short rect_color, const char hollow_char, const short hollow_color );
		void Set( const r2::Vector2& pivot, const uint32_t width, const uint32_t height, const char rect_char, const char hollow_char );
